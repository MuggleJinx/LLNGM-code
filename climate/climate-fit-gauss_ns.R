...
summary(fit_gauss_ns)
traceplot(fit_gauss_ns, "matern", combine = FALSE)
traceplot(fit_gauss_ns, combine = FALSE)

saveRDS(fit_gauss_ns, file = "model-fits/climate-fit-gauss-ns.rds")
